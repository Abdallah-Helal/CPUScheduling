...
public class Priority {
    Priority() {
        ...
        String [] OrderedWaitingList = new String[n];     //arrray to store order of finished processes
        int pos = 0 ;
        int end=0;
        int mn = 2000 ;
...
//            }
        ...
        System.out.println("");
        System.out.println("Finished processes "+"   Waiting Time "+"   Turnaround Time ");
        for (int i=0;i<n;i++){
            System.out.println(OrderedWaitingList[i]+"\t\t\t\t\t "+waitingList.get(i)+"\t\t\t\t\t "+turnaroundList.get(i));
        }
